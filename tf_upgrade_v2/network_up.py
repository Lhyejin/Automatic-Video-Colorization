...
def VCN(input, channel=32, output_channel=3,reuse=False,ext="",div_num=4):
    ...
    conv9=tf.compat.v1.layers.conv2d(conv9,output_channel*div_num,[3,3],padding='same', activation=None, kernel_initializer=tf.compat.v1.keras.initializers.VarianceScaling(scale=1.0, mode="fan_avg", distribution="uniform"), name=ext+'g_conv9_2')
    return conv9
...
def VCRN(input, channel=32, output_channel=3,reuse=False,ext="VCRN"):
    ...
    pool1=tf.compat.v1.layers.max_pooling2d(conv1, 2, 2, padding='same' )
    conv2=tf.compat.v1.layers.conv2d(pool1,channel*2,[3,3], padding='same',activation=lrelu, kernel_initializer=tf.compat.v1.keras.initializers.VarianceScaling(scale=1.0, mode="fan_avg", distribution="uniform"),name=ext+'r_conv2_1')
    conv2=tf.compat.v1.layers.conv2d(conv2,channel*2,[3,3],padding='same', activation=lrelu, kernel_initializer=tf.compat.v1.keras.initializers.VarianceScaling(scale=1.0, mode="fan_avg", distribution="uniform"),name=ext+'r_conv2_2')
    pool2=tf.compat.v1.layers.max_pooling2d(conv2, 2, 2, padding='same' )
    conv3=tf.compat.v1.layers.conv2d(pool2,channel*4,[3,3], padding='same',activation=lrelu, kernel_initializer=tf.compat.v1.keras.initializers.VarianceScaling(scale=1.0, mode="fan_avg", distribution="uniform"),name=ext+'r_conv3_1')
    conv3=tf.compat.v1.layers.conv2d(conv3,channel*4,[3,3], padding='same',activation=lrelu, kernel_initializer=tf.compat.v1.keras.initializers.VarianceScaling(scale=1.0, mode="fan_avg", distribution="uniform"),name=ext+'r_conv3_2')
    pool3=tf.compat.v1.layers.max_pooling2d(conv3, 2, 2, padding='same' )
    conv4=tf.compat.v1.layers.conv2d(pool3,channel*8,[3,3], padding='same',activation=lrelu, kernel_initializer=tf.compat.v1.keras.initializers.VarianceScaling(scale=1.0, mode="fan_avg", distribution="uniform"),name=ext+'r_conv4_1')
    conv4=tf.compat.v1.layers.conv2d(conv4,channel*8,[3,3], padding='same',activation=lrelu, kernel_initializer=tf.compat.v1.keras.initializers.VarianceScaling(scale=1.0, mode="fan_avg", distribution="uniform"),name=ext+'r_conv4_2')
    pool4=tf.compat.v1.layers.max_pooling2d(conv4, 2, 2, padding='same' )
    conv5=tf.compat.v1.layers.conv2d(pool4,channel*16,[3,3], padding='same',activation=lrelu, kernel_initializer=tf.compat.v1.keras.initializers.VarianceScaling(scale=1.0, mode="fan_avg", distribution="uniform"),name=ext+'r_conv5_1')
    conv5=tf.compat.v1.layers.conv2d(conv5,channel*16,[3,3], padding='same',activation=lrelu, kernel_initializer=tf.compat.v1.keras.initializers.VarianceScaling(scale=1.0, mode="fan_avg", distribution="uniform"),name=ext+'r_conv5_2')
    up6 =  bilinear_up_and_concat( conv5, conv4, channel*8, channel*16, scope=ext+"r_up_1" )
    conv6=tf.compat.v1.layers.conv2d(up6,  channel*8,[3,3], padding='same',activation=lrelu, kernel_initializer=tf.compat.v1.keras.initializers.VarianceScaling(scale=1.0, mode="fan_avg", distribution="uniform"),name=ext+'r_conv6_1')
    conv6=tf.compat.v1.layers.conv2d(conv6,channel*8,[3,3], padding='same',activation=lrelu, kernel_initializer=tf.compat.v1.keras.initializers.VarianceScaling(scale=1.0, mode="fan_avg", distribution="uniform"),name=ext+'r_conv6_2')
    up7 =  bilinear_up_and_concat( conv6, conv3, channel*4, channel*8, scope=ext+"r_up_2" )
    conv7=tf.compat.v1.layers.conv2d(up7,  channel*4,[3,3], padding='same',activation=lrelu, kernel_initializer=tf.compat.v1.keras.initializers.VarianceScaling(scale=1.0, mode="fan_avg", distribution="uniform"),name=ext+'r_conv7_1')
    conv7=tf.compat.v1.layers.conv2d(conv7,channel*4,[3,3], padding='same',activation=lrelu, kernel_initializer=tf.compat.v1.keras.initializers.VarianceScaling(scale=1.0, mode="fan_avg", distribution="uniform"),name=ext+'r_conv7_2')
    up8 =  bilinear_up_and_concat( conv7, conv2, channel*2, channel*4, scope=ext+"r_up_3" )
    conv8=tf.compat.v1.layers.conv2d(up8,  channel*2,[3,3], padding='same',activation=lrelu, kernel_initializer=tf.compat.v1.keras.initializers.VarianceScaling(scale=1.0, mode="fan_avg", distribution="uniform"),name=ext+'r_conv8_1')
    conv8=tf.compat.v1.layers.conv2d(conv8,channel*2,[3,3], padding='same',activation=lrelu, kernel_initializer=tf.compat.v1.keras.initializers.VarianceScaling(scale=1.0, mode="fan_avg", distribution="uniform"),name=ext+'r_conv8_2')
    up9 =  bilinear_up_and_concat( conv8, conv1, channel, channel*2, scope=ext+"r_up_4" )
    conv9=tf.compat.v1.layers.conv2d(up9,  channel,[3,3],  padding='same',activation=lrelu, kernel_initializer=tf.compat.v1.keras.initializers.VarianceScaling(scale=1.0, mode="fan_avg", distribution="uniform"),name=ext+'r_conv9_1')
    conv9=tf.compat.v1.layers.conv2d(conv9,output_channel,[3,3], padding='same',activation=None,  kernel_initializer=tf.compat.v1.keras.initializers.VarianceScaling(scale=1.0, mode="fan_avg", distribution="uniform"),name=ext+'r_conv9_2')
    return conv9
